...
{
    public sealed class PostDetailFindByIdQueryService : IPostDetailFindByIdQueryService
    {
        private readonly ShareLaboPGSQLConnectionFactory _connectionFactory;

        public PostDetailFindByIdQueryService(ShareLaboPGSQLConnectionFactory connectionFactory)
        {

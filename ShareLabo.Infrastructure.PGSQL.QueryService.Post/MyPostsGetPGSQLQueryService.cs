...
{
    public sealed class MyPostsGetPGSQLQueryService : IMyPostsGetQueryService
    {
        private readonly ShareLaboPGSQLConnectionFactory _connectionFactory;

        public MyPostsGetPGSQLQueryService(ShareLaboPGSQLConnectionFactory connectionFactory)
        {

...
{
    public sealed class FollowedPostsGetPGSQLQueryService : IFollowedPostsGetQueryService
    {
        private readonly ShareLaboPGSQLConnectionFactory _connectionFactory;

        public FollowedPostsGetPGSQLQueryService(ShareLaboPGSQLConnectionFactory connectionFactory)
        {

...
{
    public sealed class TimeLinePostsGetPGSQLQueryService : ITimeLinePostsGetQueryService
    {
        private readonly ShareLaboPGSQLConnectionFactory _connectionFactory;

        public TimeLinePostsGetPGSQLQueryService(ShareLaboPGSQLConnectionFactory connectionFactory)
        {

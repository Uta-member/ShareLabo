...
{
    public sealed class GeneralPostsGetPGSQLQueryService : IGeneralPostsGetQueryService
    {
        private readonly ShareLaboPGSQLConnectionFactory _connectionFactory;

        public GeneralPostsGetPGSQLQueryService(ShareLaboPGSQLConnectionFactory connectionFactory)
        {
            _connectionFactory = connectionFactory;
        }

        public async ValueTask<IGeneralPostsGetQueryService.Res> ExecuteAsync(
            IGeneralPostsGetQueryService.Req req,

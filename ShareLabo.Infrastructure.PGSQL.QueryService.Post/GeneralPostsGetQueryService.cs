...
{
    public sealed class GeneralPostsGetQueryService : IGeneralPostsGetQueryService
    {
        private readonly ShareLaboPGSQLConnectionFactory _connectionFactory;

        public GeneralPostsGetQueryService(ShareLaboPGSQLConnectionFactory connectionFactory)
        {
